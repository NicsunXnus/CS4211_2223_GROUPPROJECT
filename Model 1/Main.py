...
def readfile(season):
    ...
    template_file_4f_3rows = '4rowsTemplate.pcsp'
    template_file_4f = '4rowsTemplate.pcsp'
    template_file_5f = '5rowsTemplate.pcsp'
    template_file_5f_3rows = '5rowsTemplate_3rows.pcsp'
    template_file_5f_4rows = '5rowsTemplate_4rows.pcsp'
