...
from MainFunctions import create_template_files, softmax
...
def readfile(season):
    ...
    template_file_3f = '3rowTemplateN.pcsp'
    template_file_4f_3rows = '4rowsTemplateN.pcsp'
    template_file_4f = '4rowsTemplateN.pcsp'
    template_file_5f = '5rowsTemplateN.pcsp'
    template_file_5f_3rows = '5rowsTemplateN.pcsp'
    template_file_5f_4rows = '5rowsTemplateN.pcsp'
    
    match_url_arr = []
    
    # Create the PAT files
    match_url_arr = create_template_files(df_match, df_ratings,season, template_file_3f,template_file_4f_3rows,template_file_4f,template_file_5f,template_file_5f_3rows,template_file_5f_4rows,  match_url_arr)
        ...
        for ind,file_name in enumerate(os.listdir(out_path)):
            ...
            if ind % 2 == 0:               
                with open(file_name, 'r') as file:
                    ...
                    get_prob = lines[21].split(']')[0].split('[')[1].split(',')
